...
def make_small_instance() -> Instance:
    ...
    """
    cities = []
    with open("/Users/default/Desktop/CS 170/small.in") as input:
        for line in input:
            coords = line.split()
            if len(coords) != 2:
                continue
            cities.append(Point(int(coords[0]), int(coords[1])))
...
def make_medium_instance() -> Instance:
    ...
    """
    cities = []
    with open("/Users/default/Desktop/CS 170/medium.in") as input:
        for line in input:
            coords = line.split()
            if len(coords) != 2:
                continue
...
def make_large_instance() -> Instance:
    ...
    """
    cities = []
    with open("/Users/default/Desktop/CS 170/large.in") as input:
        for line in input:
            coords = line.split()
            if len(coords) != 2:
                continue
